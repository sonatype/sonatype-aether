...
/**
 * Holds all POM files that are known to the reactor/workspace. This allows the model builder to resolve imported POMs
 * from the reactor when building another effective model.
 * 
 * @author Benjamin Bentmann
 */
public class WorkspaceModelPool
{
